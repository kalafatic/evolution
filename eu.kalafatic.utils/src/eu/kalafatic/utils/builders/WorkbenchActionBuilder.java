...
//            helpToolBar.add(searchComboItem);
    ...
    private MenuManager createSearchMenu() {
    	 MenuManager menu = new MenuManager("Search", "Search");
...
/**
	...
	private MenuManager addPerspectiveActions() {
		MenuManager menu = new MenuManager("Perspective", "&Perspective");
		menu.add(new GroupMarker("perspectiveStart"));
...
//					buildAllCmd.setEnabled(handlerService.getCurrentState());
 ...
 // ---------------------------------------------------------------
 	 ...
 	 * @return the flag
 	 */
 	protected Image getFlag(String locale) {
