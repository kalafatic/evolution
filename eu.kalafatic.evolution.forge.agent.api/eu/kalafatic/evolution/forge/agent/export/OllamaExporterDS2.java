...
public class OllamaExporterDS2 implements EvoModelExporter {
    ...
    public void export(String modelName, Path outputPath, EvoLlmModel model, java.util.Map<Integer, String> customVocab) throws IOException {
        System.out.println("[Export-DS2] Starting genuine EVO model export to: " + outputPath.toAbsolutePath());
        ...
        System.out.println("[Export-DS2] GGUF file written successfully: " + ggufPath.toAbsolutePath() + " (" + Files.size(ggufPath) + " bytes)");
