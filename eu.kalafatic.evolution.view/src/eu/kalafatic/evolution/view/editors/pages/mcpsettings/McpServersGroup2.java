...
public class McpServersGroup2 extends AEvoGroup {
    private Table serversTable;
    private McpSettingsPage page;

    public McpServersGroup2(FormToolkit toolkit, Composite parent, MultiPageEditor editor, Orchestrator orchestrator, McpSettingsPage page) {
