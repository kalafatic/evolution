...
public class DevelopmentPage extends AEvoPage {
	...
	private void loadTableData() {
		...
		int orderCounter = 1;
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.LLM_CHECK, llmModel, "ready", "evo"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.GIT_CHECK_EVO, gitPathUrl, "ready", "evo"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.MAVEN_CHECK_EVO, mvnPath, "ready", "evo"));		
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.COPY_SUPERVISOR_SRC, customSuperSrc, "ready", "evo"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.BUILD_SUPERVISOR_LOCAL, customSuperBin, "ready", "evo"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.SUPERVISOR_CHECK, "supervisor.exe", "ready", "evo"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.GIT_CHECK_SUPERVISOR, gitPathUrl, "ready", "supervisor"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.MAVEN_CHECK_SUPERVISOR, mvnPath, "ready", "supervisor"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.GENOME_CHECK, "supervisor.genome", "ready", "evo"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.PERM_CHECK, "supervisor.fs", "ready", "evo"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.COPY_SOURCE, getSupervisorSourcePath(), "ready", "evo"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.BUILD_PROJECT_EVO, targetPath, "ready", "evo"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.BUILD_PROJECT_SUPERVISOR, targetPath, "ready", "supervisor"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.EXPORT_PRODUCT_EVO, exportPath, "ready", "evo"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.EXPORT_PRODUCT_SUPERVISOR, exportPath, "ready", "supervisor"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.START_EVO_PRODUCT_SUPERVISOR, exportPath, "ready", "supervisor"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.SUPERVISOR_LOOP, "supervisor.exe", "ready", "NA"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.SELF_DEV_LOOP, "orchestrator", "ready", "NA"));
		sdData.add(new SelfDevRow(orderCounter++, SelfDevRow.STOP_EVO_PRODUCT_SUPERVISOR, exportPath, "ready", "supervisor"));
