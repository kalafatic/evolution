...
//
//public class McpSettingsPage2 extends AEvoPage {
//
...
//
//	public McpSettingsPage2(Composite parent, MultiPageEditor editor, Orchestrator orchestrator) {
...
//	}
//
//	private void init(Orchestrator orchestrator) {
...
//				});
//			} catch (Exception ex) {
//				System.err.println("Error refreshing tools: " + ex.getMessage());
//				Display.getDefault().asyncExec(() -> {
//					if (resourcesGroup.isDisposed())
//						return;
...
//					MessageBox mb = new MessageBox(getShell(), SWT.ICON_ERROR | SWT.OK);
//					mb.setText("Error");
//					mb.setMessage("Failed to list tools: " + ex.getMessage());
//					mb.open();
//				});
//			}
//		}).start();
...
//					MessageBox mb = new MessageBox(getShell(), SWT.ICON_ERROR | SWT.OK);
//					mb.setText("Error");
//					mb.setMessage("Failed to list prompts: " + ex.getMessage());
//					mb.open();
//				});
//			}
//		}).start();
