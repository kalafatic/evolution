...
public class ReviewGroup extends AEvoGroup {
    ...
    private String getDiffHtml(String gitDiff, String internalJson) {
        return "<!DOCTYPE html><html><head><style>"
            + eu.kalafatic.evolution.controller.ui.EvoStyleManager.getInstance().getEvoStyleCss()
            + "body { font-family: var(--evo-font-family); margin: 10px; background-color: var(--evo-bg); color: var(--evo-text); }"
            + ".file-container { border: 1px solid var(--evo-border); border-radius: var(--evo-radius); margin-bottom: 15px; background: var(--evo-surface); overflow: hidden; }"
            + ".file-header { background: var(--evo-surface-alt); padding: 8px 12px; border-bottom: 1px solid var(--evo-border); display: flex; justify-content: space-between; align-items: center; cursor: pointer; }"
            + ".file-path { font-weight: bold; color: var(--evo-primary); text-decoration: underline; }"
            + ".diff-content { padding: 0; font-family: var(--evo-font-mono); font-size: 11px; white-space: pre; overflow-x: auto; display: block; }"
            + ".line { display: block; padding: 0 10px; min-height: 1.2em; }"
            + ".added { background-color: var(--evo-success-light); color: var(--evo-success); }"
            + ".deleted { background-color: var(--evo-danger-light); color: var(--evo-danger); }"
            + ".info { background-color: var(--evo-primary-light); color: var(--evo-primary); }"
            + "h3 { border-bottom: 2px solid var(--evo-primary); padding-bottom: 5px; color: var(--evo-primary); }"
            + ".fallback-tag { font-size: 10px; background: var(--evo-warning-light); color: var(--evo-warning); padding: 2px 5px; border-radius: var(--evo-radius); margin-left: 10px; border: 1px solid var(--evo-warning); }"
            + "</style></head><body>"
