        ...
        if (orchestrator != null) {
            for (Class<?> testClass : page.getDiscoveredTestClasses()) {
                ...
                radio.addSelectionListener(new SelectionAdapter() {
                    @Override public void widgetSelected(SelectionEvent e) { if (radio.getSelection()) page.handleTestSelection(finalTest); }
                });
                ...
                execBtn.addSelectionListener(new SelectionAdapter() {
                    @Override public void widgetSelected(SelectionEvent e) { page.executeTest(finalTest); }
                });
                actionComp.pack();
