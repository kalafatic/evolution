...
//
//public class McpSettingsPage4 extends AEvoPage {
//
...
//
//	public McpSettingsPage4(Composite parent, MultiPageEditor editor, Orchestrator orchestrator) {
...
////					mb.setMessage("Error connecting to MCP server: " + errorMsg);
////					mb.open();
////				});
//			}
//		}).start();
...
////					MessageBox mb = new MessageBox(getShell(), SWT.ICON_ERROR | SWT.OK);
////					mb.setText("Error");
////					mb.setMessage("Failed to start MCP Demo Server: "
...
////					mb.setMessage(
////							"Error sending request: " + (ex.getMessage() != null ? ex.getMessage() : ex.toString()));
////					mb.open();
////				});
//			}
//		}).start();
...
////					mb.setText("Error");
////					mb.setMessage(
////							"Failed to list resources: " + (ex.getMessage() != null ? ex.getMessage() : ex.toString()));
////					mb.open();
////				});
//			}
//		}).start();
...
////					mb.setText("Error");
////					mb.setMessage(
////							"Failed to list tools: " + (ex.getMessage() != null ? ex.getMessage() : ex.toString()));
////					mb.open();
////				});
//			}
//		}).start();
...
//					mb.setText("Error");
//					mb.setMessage(
//							"Failed to list prompts: " + (ex.getMessage() != null ? ex.getMessage() : ex.toString()));
//					mb.open();
//				});
//			}
//		}).start();
