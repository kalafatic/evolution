...
public class TestsPage extends AEvoPage {
	...
	public String getIterativeHtmlTemplate() {
		return "<!DOCTYPE html><html><head><style>"
				...
				+ "body { font-family: var(--evo-font-family); background: var(--evo-bg); margin: 0; padding: 20px; overflow: hidden; }"
				+ ".node { fill: var(--evo-surface-alt); stroke: var(--evo-border); stroke-width: 2px; transition: all 0.3s; }"
				+ ".node.active { fill: var(--evo-primary-light); stroke: var(--evo-primary); stroke-width: 3px; animation: pulse 1.5s infinite; }"
				+ ".node.success { fill: var(--evo-success-light); stroke: var(--evo-success); }"
				+ ".node.failed { fill: var(--evo-danger-light); stroke: var(--evo-danger); }"
				+ ".node.skipped { fill: var(--evo-surface-alt); stroke: var(--evo-border-dark); stroke-dasharray: 4; }"
				+ ".edge { stroke: var(--evo-border-dark); stroke-width: 2px; fill: none; marker-end: url(#arrow); transition: stroke 0.3s; }"
				+ ".edge.active { stroke: var(--evo-primary); stroke-width: 3px; }"
				+ ".label { font-size: 10px; font-weight: 600; fill: var(--evo-text-secondary); text-anchor: middle; pointer-events: none; }"
