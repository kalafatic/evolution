...
/**
 * This is the item provider adapter for a {@link eu.kalafatic.evolution.model.orchestration.FileConfig} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileConfigItemProvider 
	 ...
	 * @generated
	 */
	public FileConfigItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FileConfig"));
	}
	...
	public String getText(Object object) {
		String label = ((FileConfig)object).getLocalPath();
		return label == null || label.length() == 0 ?
			getString("_UI_FileConfig_type") :
			getString("_UI_FileConfig_type") + " " + label;
	}
