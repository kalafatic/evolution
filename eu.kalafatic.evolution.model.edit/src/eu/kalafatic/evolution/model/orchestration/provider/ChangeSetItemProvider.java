...
/**
 * This is the item provider adapter for a {@link eu.kalafatic.evolution.model.orchestration.ChangeSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChangeSetItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ChangeSet_commitId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ChangeSet_commitId_feature", "_UI_ChangeSet_type"),
				 OrchestrationPackage.Literals.CHANGE_SET__COMMIT_ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OrchestrationPackage.Literals.CHANGE_SET__FILES);
		}
	...
	public String getText(Object object) {
		String label = ((ChangeSet)object).getCommitId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OrchestrationPackage.Literals.CHANGE_SET__FILES,
				 OrchestrationFactory.eINSTANCE.createFileChange()));
	}
