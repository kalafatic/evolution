...
/**
 * This is the item provider adapter for a {@link orchestration.Orchestrator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addAgentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Orchestrator_agents_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Orchestrator_agents_feature", "_UI_Orchestrator_type"),
