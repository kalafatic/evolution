...
/**
 * This is the item provider adapter for a {@link orchestration.Command} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OrchestrationPackage.Literals.COMMAND__NAME,
				 true,
				 false,
				 false,
	...
	protected void addStatusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Command_status_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Command_status_feature", "_UI_Command_type"),
				 OrchestrationPackage.Literals.COMMAND__STATUS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
