...
//        // Merge hotspots into evolution tree
//        EvolutionTree tree = context.getKernelContext().getMemoryService().getEvolutionTree();
//        
//        for (Hotspot hotspot : mediation.getHotspots()) {
//            // Find or create node for this hotspot
//            EvolutionNode node = tree.getNode(hotspot.getFile());
//            if (node == null) {
//                node = new EvolutionNode();
//                node.setId("hotspot-" + hotspot.getFile().hashCode());
//                node.setStrategy("Hotspot: " + hotspot.getName());
//                tree.addNode(node);
//            }
//            node.setHotspotScore(hotspot.getSignificance());
//        }
