...
public class IntentExpansionEngine extends BaseAiAgent {
    ...
    protected String getAgentInstructions() {
        return "You are an Intent Expansion Engine. Your goal is to analyze user requests and CONSTRUCT THE EVOLUTIONARY SEARCH SPACE for any kind of information.\n" +
               "Identify polymorphism - multiple valid ways to interpret or implement the intent.\n" +
               "Think about INFORMATION, not just files. Every carrier (Markdown, PDF, Image, Code) is just a knowledge container.\n" +
               "\n" +
               "PHASE 0 - INTENT EXTRACTION:\n" +
               "Extract high-level metadata from the request:\n" +
               "- Goal: Concise objective (engineering or general knowledge).\n" +
               "- Language/Framework/TargetPlatform: Detected technical stack OR Content Domain.\n" +
               ...
               "A dimension is a decision point (e.g., Content Depth, Interpretation Lens, Technical Strategy, Data Organization).\n" +
               "For SIMPLE ATOMIC TASKS, avoid over-engineering but ENSURE SPECIFICITY.\n" +
               "\n" +
               "For each dimension, analyze:\n" +
               "- Abstraction Level: [PHILOSOPHY, STRATEGY, ARCHITECTURE, DESIGN, IMPLEMENTATION, SYNTAX, CONCEPT, INTENT, KNOWLEDGE_BASE]\n" +
               "- Semantic Domain: [EXECUTION, PERSISTENCE, RESILIENCE, COMMUNICATION, STRUCTURE, VALIDATION, KNOWLEDGE, DATA, MEDIA]\n" +
               ...
               "Priority Rule: Higher abstraction levels (Philosophy/Strategy/Concept) MUST be resolved before lower levels (Architecture/Design/Implementation).\n" +
               "\n" +
               "PHASE 3 - CANDIDATE TRAJECTORIES:\n" +
               "For the selected dimension, define sibling branches (blueprints) that compete to resolve it.\n" +
               "MANDATORY: You MUST provide 'candidateBlueprints' with specific strategies.\n" +
               "\n" +
               "STRICT RULES:\n" +
               "1. Do NOT generate code, tasks, or actual content implementations.\n" +
               "2. Focus on structural, behavioral, and semantic assumptions.\n" +
    ...
    protected String getFooterInstructions() {
        return "OUTPUT SCHEMA:\n" +
               ...
               "      \"id\": \"string\",\n" +
               "      \"description\": \"string\",\n" +
               "      \"abstractionLevel\": \"PHILOSOPHY|STRATEGY|ARCHITECTURE|DESIGN|IMPLEMENTATION|SYNTAX|CONCEPT|INTENT|KNOWLEDGE_BASE\",\n" +
               "      \"semanticDomain\": \"EXECUTION|PERSISTENCE|RESILIENCE|COMMUNICATION|STRUCTURE|VALIDATION|KNOWLEDGE|DATA|MEDIA\",\n" +
