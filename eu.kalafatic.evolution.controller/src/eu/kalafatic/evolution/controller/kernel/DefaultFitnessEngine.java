...
public class DefaultFitnessEngine implements FitnessEngine {
    ...
    public DefaultFitnessEngine(Evaluator evaluator) {
        this.evaluator = evaluator;
    }

    @Override
    public EvaluationResult evaluate(File projectRoot, TaskContext context) throws Exception {
        IEvaluationContract contract = CapabilityRegistry.getInstance().getContractImplementation(IEvaluationContract.ID, IEvaluationContract.class);
