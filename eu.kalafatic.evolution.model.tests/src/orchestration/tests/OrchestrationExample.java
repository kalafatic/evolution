...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>orchestration</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class OrchestrationExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.orchestration"));
				Task root = OrchestrationFactory.eINSTANCE.createTask();
