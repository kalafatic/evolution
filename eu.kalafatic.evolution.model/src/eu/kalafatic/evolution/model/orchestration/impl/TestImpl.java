 ...
 * </p>
 * <ul>
 *   <li>{@link eu.kalafatic.evolution.model.orchestration.impl.TestImpl#getId <em>Id</em>}</li>
 *   <li>{@link eu.kalafatic.evolution.model.orchestration.impl.TestImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.kalafatic.evolution.model.orchestration.impl.TestImpl#getType <em>Type</em>}</li>
 *   <li>{@link eu.kalafatic.evolution.model.orchestration.impl.TestImpl#getPath <em>Path</em>}</li>
 *   <li>{@link eu.kalafatic.evolution.model.orchestration.impl.TestImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link eu.kalafatic.evolution.model.orchestration.impl.TestImpl#isSelected <em>Selected</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestImpl extends MinimalEObjectImpl.Container implements Test {
	 ...
	 * @ordered
	 */
	protected static final TestStatus STATUS_EDEFAULT = TestStatus.PENDING;
	...
	protected EClass eStaticClass() {
		return OrchestrationPackage.Literals.TEST;
	}
